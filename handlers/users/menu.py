...
from keyboards.default.menu_keyboards import back_to_menu_menu
from keyboards.inline.inline_keyboards import cancel_markup
from loader import dp, db, bot
from states.menu_states import NewFilters, Reports
...
@dp.message_handler(IsMemberMessage(), Text(endswith='Настройка фильтра'))
...
@dp.message_handler(IsMemberMessage(), Text(endswith='Помощь / Инструкция'))
